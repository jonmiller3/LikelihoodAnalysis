...
void TH3FSpec::GetRandom3Spec(Double_t &x, Double_t &y, Double_t &z, int seed)
{
...
Int_t TH3FSpec::GetRandom3Spec(int seed)
{
...
void TH2FSpec::GetRandom2Spec(Double_t &x, Double_t &y, int seed)
{
    // return 2 random numbers along axis x and y distributed according
    // the cellcontents of a 2-dim histogram
...
double TH1FSpec::GetRandomSpec(int seed){
...
Bool_t TH1FSpec::AddFast(const TH1FSpec *h1, const TH1FSpec *h2, Double_t c1, Double_t c2){
    ...
    const Float_t* dArrayA = h1->GetArray();
    const Float_t* dArrayB = h2->GetArray();
    //double* dArrayC = 0;
...
Bool_t TH2FSpec::AddFast(const TH2FSpec *h1, const TH2FSpec *h2, Double_t c1, Double_t c2){
...
Bool_t TH3FSpec::AddFast(const TH3FSpec *h1, const TH3FSpec *h2, Double_t c1, Double_t c2){
